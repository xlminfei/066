...
- [当前模型对Null比较](context/v3.4/results/model_vs_null.csv)
- [旧版42项比较](context/repository/v2/results/derived/paired_elpd_comparisons.csv)
- [旧版按折数的九项校正表](context/repository/v2/results/derived/paired_elpd_M1M2M3_vs_Null_corrections_by_fold.csv)
- [M3对照总表](source/elpd_audit/M3_joint_pvalue_reconciliation.csv)
- [同一OOF的方法与权重对照](source/elpd_audit/fixed_OOF_method_weighting_counterfactuals.csv)
- [按物种的配对预测增益](source/elpd_audit/paired_species_logscore_contributions.csv)
- [bootstrap数值稳定性检查](source/elpd_audit/bootstrap_numerical_stability_audit.csv)
- [历史表来源差异](source/elpd_audit/v2_historical_table_source_discrepancy.csv)
- [独立P/BH和源文件完整性验证](source/elpd_audit/independent_P_BH_and_source_integrity.json)

源码定位：

- [paired_elpd_analysis.R](context/repository/v2/src/paired_elpd_analysis.R)
- [ELPD_CORRECTION_BY_FOLD_zh.md](context/repository/v2/reports/ELPD_CORRECTION_BY_FOLD_zh.md)
- [comparison.R](context/v3.4/R/comparison.R)
- [cross_validation.R](context/v3.4/R/cross_validation.R)
- [data_encoding.R](context/v3.4/R/data_encoding.R)
- [analysis.json](context/v3.4/config/analysis.json)
- [06_留出验证.md](context/repository/v1/docs/06_留出验证.md)
- [postfit_cv.R](context/repository/v1/src/postfit_cv.R)
