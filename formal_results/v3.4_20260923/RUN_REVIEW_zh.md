...
正式对象共256个、均非空，总字节11350681431；16个全数据拟合和240个CV拟合身份集合与任务计划完全一致。详见 [全部256项保存诊断汇总](snapshot/run_logs_v34_20260922204324/postrun_check_20260923/all_256_saved_diagnostics.csv)。
...
| 文件 | 数据行数 |
|---|---:|
| [calibration_bins.csv](snapshot/v3.4/results/calibration_bins.csv) | 110 |
| [cv_fold_metrics.csv](snapshot/v3.4/results/cv_fold_metrics.csv) | 480 |
| [cv_metrics_summary.csv](snapshot/v3.4/results/cv_metrics_summary.csv) | 64 |
| [cv_record_predictions.csv](snapshot/v3.4/results/cv_record_predictions.csv) | 4880 |
| [folds_binary_species_10.csv](snapshot/v3.4/results/folds_binary_species_10.csv) | 50 |
| [folds_binary_species_5.csv](snapshot/v3.4/results/folds_binary_species_5.csv) | 50 |
| [folds_joint_bb_species_10.csv](snapshot/v3.4/results/folds_joint_bb_species_10.csv) | 51 |
| [folds_joint_bb_species_5.csv](snapshot/v3.4/results/folds_joint_bb_species_5.csv) | 51 |
| [full_diagnostics.csv](snapshot/v3.4/results/full_diagnostics.csv) | 16 |
| [full_panel_predictions.csv](snapshot/v3.4/results/full_panel_predictions.csv) | 5840 |
| [model_vs_null.csv](snapshot/v3.4/results/model_vs_null.csv) | 48 |
| [model_vs_null_by_fold.csv](snapshot/v3.4/results/model_vs_null_by_fold.csv) | 360 |
| [quantitative_bias_summary.csv](snapshot/v3.4/results/quantitative_bias_summary.csv) | 32 |
| [quantitative_plot_source.csv](snapshot/v3.4/results/quantitative_plot_source.csv) | 4640 |
| [roc_coordinates.csv](snapshot/v3.4/results/roc_coordinates.csv) | 1144 |
| [training_method_comparisons.csv](snapshot/v3.4/results/training_method_comparisons.csv) | 32 |
| [training_method_comparisons_by_fold.csv](snapshot/v3.4/results/training_method_comparisons_by_fold.csv) | 240 |
| [training_ppc_summary.csv](snapshot/v3.4/results/training_ppc_summary.csv) | 256 |
| [training_weights.csv](snapshot/v3.4/results/training_weights.csv) | 34160 |
| [training_weights_cv.csv](snapshot/v3.4/results/training_weights_cv.csv) | 31720 |
| [training_weights_full.csv](snapshot/v3.4/results/training_weights_full.csv) | 2440 |
...
| PDF文件 | 页数 | 检查结果 |
|---|---:|---|
| [ROC_curves.pdf](snapshot/v3.4/figures/ROC_curves.pdf) | 8 | 完整解析、全部渲染、目视检查通过 |
| [calibration_bins.pdf](snapshot/v3.4/figures/calibration_bins.pdf) | 8 | 完整解析、全部渲染、目视检查通过 |
| [quantitative_predicted_observed.pdf](snapshot/v3.4/figures/quantitative_predicted_observed.pdf) | 8 | 完整解析、全部渲染、目视检查通过 |
| [training_ppc_summary.pdf](snapshot/v3.4/figures/training_ppc_summary.pdf) | 16 | 完整解析、全部渲染、目视检查通过 |
| [species_predictions_binary_record_equal.pdf](snapshot/v3.4/figures/species_predictions_binary_record_equal.pdf) | 9 | 完整解析、全部渲染、目视检查通过 |
| [species_predictions_binary_species_equal.pdf](snapshot/v3.4/figures/species_predictions_binary_species_equal.pdf) | 9 | 完整解析、全部渲染、目视检查通过 |
| [species_predictions_joint_bb_record_equal.pdf](snapshot/v3.4/figures/species_predictions_joint_bb_record_equal.pdf) | 9 | 完整解析、全部渲染、目视检查通过 |
| [species_predictions_joint_bb_species_equal.pdf](snapshot/v3.4/figures/species_predictions_joint_bb_species_equal.pdf) | 9 | 完整解析、全部渲染、目视检查通过 |
...
正式报告已生成：[REPORT_v3_4.md](snapshot/v3.4/reports/REPORT_v3_4.md)。这次检查的范围是既定all流程输出完整性和图件可用性，不等于对模型科学效能作最终判断。
...
网页浏览副本：仅将本地文件链接改为仓库相对链接；原始文件按字节保存在 snapshot/run_logs_v34_20260922204324/postrun_check_20260923/RUN_COMPLETION_REVIEW_zh.md，完整归档中亦保留原文。
