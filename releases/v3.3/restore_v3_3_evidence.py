#!/usr/bin/env python3
"""Download, verify and reassemble the v3.3 complete evidence archive (public assets)."""
import argparse, hashlib, json, os, pathlib, re, tempfile, urllib.request
BASE = "https://github.com/xlminfei/066/releases/download/v3.3/"
MANIFEST_NAME = "v3.3-complete-evidence.parts.json"
MANIFEST_SHA = "b86dbf4132210f71f3685597e33054174ac724d9fcf9ab80e4c432cee9b56e9e"
ARCHIVE_SHA = "5fc2b56e7583ad0d8f5ea3a62c788438f39bf9d163c01fb934b932e50981492e"
def digest(p):
    h = hashlib.sha256()
    with open(p, "rb") as f:
...
def main():
    ...
    parser.add_argument("--directory", default="v3.3-complete-data")
    ...
    for i, part in enumerate(spec["parts"], 1):
        if part["index"] != i or part["name"] != "v3.3-complete-evidence.zip.part%03d" % i: raise ValueError("Invalid part order/name")
